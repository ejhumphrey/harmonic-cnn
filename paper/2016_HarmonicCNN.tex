...
The harmonic CNN is somewhat more difficult to implement, since the $h$ harmonic of a frequency $f$ will not generally coincide with an integer bin number.
...
$X^1$ is defined as a CQT with minimum basis frequency $f^1_{\min}$ and $B$ bins per octave.
