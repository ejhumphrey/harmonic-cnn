...
% Title.
% ------
\title{Toward Harmonic Convolutions in Neural Networks}
...
Convolutional neural networks (CNNs), originally pioneered in computer vision, have shown great performance in content-based MIR across a variety of challenges.
...
Whereas images exhibit spatial correlations between pixels, sound is harmonic, and thus fundamental assumptions about the convolutional architecture are potentially invalid.
...
% How do we do it?
We study these approaches in a large, solo instrument classification task, taking the union of three datasets.
% What do we find?
